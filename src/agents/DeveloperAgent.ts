...
class TaskTrackerTool extends Tool {
    ...
    async execute(args: { action: string; content?: string }): Promise<string> {
...
class ProjectIndexerTool extends Tool {
    ...
    async execute(args: { depth?: number }): Promise<string> {
        ...
        const walk = (dir: string, currentDepth: number): string => {
...
export class DeveloperAgent extends BaseAgent {
    ...
    constructor() {
        super(
            "DeveloperAgent",
            `You are the **Sovereign Developer**, a world-class system architect and core developer of CORTEX. 
