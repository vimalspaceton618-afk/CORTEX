...
export class MythosAgent extends BaseAgent {
    constructor() {
        super(
            "MythosAgent",
            "You are the Mythos Threat Intelligence Agent. You use the Mythos ontological graph to scan architectures, find missing defensive capabilities ('Myth Gaps'), and orchestrate the CORTEX swarm to patch them."
        );
    }
