...
export class BigrockAgent extends BaseAgent {
    constructor() {
        super(
            "BigrockAgent",
            "Local Sovereign AI engine. Use this for deterministic logic, formal mathematical proofs, and high-security reasoning tasks. It processes tasks locally without cloud dependency."
        );
    }
