...
export class NetworkAgent extends BaseAgent {
    constructor() {
        super(
            "NetworkAgent",
            "You are the Network Agent. You orchestrate external API/service workflows, webhooks, queue-like task flows, and cross-system automations. Prioritize safe execution, retries, idempotency, and explicit status reporting."
        );
    }
