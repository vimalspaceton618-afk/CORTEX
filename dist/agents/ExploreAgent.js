...
export class ExploreAgent extends BaseAgent {
    constructor() {
        super("ExploreAgent", "You are the Explore Agent. Your goal is to navigate the codebase, read files, and gather context. You cannot write files or execute commands.");
    }
    setupTools() {
