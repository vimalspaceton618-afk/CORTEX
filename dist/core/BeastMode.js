...
export class BeastMode {
    ...
    getStatus() {
        const systems = [];
        if (this.active) {
            systems.push('ARL_AGGRESSIVE', 'NEURAL_MAX_DEPTH', 'REFLECTION_7_PASS', 'MEMORY_EXTENDED', 'ABSORBER_AUTO', 'MYTHOS_CONTINUOUS', 'AGENT_HIGH_AUTONOMY', 'TIMEOUT_EXTENDED', 'PATROL_RAPID', 'CURIOSITY_ACCELERATED');
        }
        return {
            active: this.active,
