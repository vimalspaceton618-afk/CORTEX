...
export class SecurityProcessor {
    ...
    static PRIVILEGE_ESCALATION_PATTERNS = [
    ...
    getAuditLog() { return this.audit_log; }
    getThreatCount() { return this.audit_log.filter(l => l.blocked).length; }
}
