...
export class PhysicsEngine {
    ...
    projectileMotion(v0, angle_deg, g = 9.81) {
    ...
    lengthContraction(proper_length, v) {
        const trace = [];
        const gamma = this.lorentzFactor(v);
        trace.push(...gamma.proof_trace);
    ...
    deBroglieWavelength(mass, velocity) {
        const trace = [];
    ...
    entropyChange(heat_J, temperature_K) {
        const trace = [];
