import { LiquidNeuralNetwork } from './LiquidNeuralNetwork.js';
export class ContinuousLearningCore {
     ...
     */
    processThought(domain, input, think_depth = 10) {
    ...
    getCircuitCount() { return this.circuits.size; }
    /** Check if a domain has been activated */
    hasDomain(domain) { return this.circuits.has(domain); }
}
